...
<head>
    ...
    <style>
        ...
        .main-content { margin-left: 60px; margin-top: 69px; margin-right: 60px; padding: 30px; transition: all 0.3s ease; min-height: calc(100vh - 69px); width: auto; background: transparent; }
