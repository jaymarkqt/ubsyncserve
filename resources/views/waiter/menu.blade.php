...
<div x-data="posSystem()" x-init="initStore()" class="w-full mx-auto px-4 py-6 lg:px-8 lg:py-8 min-h-screen" style="max-width: calc(100% - 120px); margin-left: 60px; margin-right: 60px; margin-top: 10px;" x-cloak>
